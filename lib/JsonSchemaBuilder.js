...
var JsonSchemaBuilder = (function () {
    ...
    JsonSchemaBuilder.prototype.oType = function (type) {
    ...
    JsonSchemaBuilder.prototype.viewProperties = function (props) {
        var _this = this;
        if (!this.schema.viewProperties) {
            this.schema.viewProperties = [];
        }
        props.forEach(function (prop) { return _this.schema.viewProperties.push(prop); });
        return this;
    };
